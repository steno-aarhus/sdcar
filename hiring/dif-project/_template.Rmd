...
details <- tribble(
    ~id, ~title, ~start_date,
    "rse", "research software engineer", "August 1",
    # Job was posted
    # "tl", "team leader", "May 1", 
    "dba", "database administrator", "August 1",
    "dm", "data manager", "TBD", 
) %>% 
...
invites applications for `r number_of_positions` as "`r details$title`" to work with a team
