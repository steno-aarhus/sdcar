...
principles. This is largely a *software* project that focuses on working with
data, but not on data itself. A description of the DIF project can be found at
...
well as the primary investigator. External and occasional collaborators include
2-3 data managers and coordinators as well as consultant software engineers.
...
- Is motivated, interested, and comfortable with working on projects that have
...
- Has some experience or familiarity with the research environment and its specific
set of needs
```
...
- **Benefits**:
    - Childcare, parental leave (dependent on country-specific factors)
