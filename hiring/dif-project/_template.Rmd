...
# For RSE add AC-TAP to output.
details <- tibble::tribble(
    ~id, ~title, ~start_date, ~duration,
    "rse", "research software engineer", "TBD", "5 years and 2 years",
    "tl", "team leader", "April 1", "5 years",
    "dba", "database administrator", "TBD", "5 years",
    "dm", "data manager", "TBD", "3 years?"
)
```
...
# `r stringr::str_to_sentence(details$title)` to a research-data infrastructure framework
...
https://www.stenoaarhus.dk/) invites applications for `r details$title`
...
This position is expected to start `r details$start_date` or as soon as possible
after this date and is for `r details$duration`.
...
### `r stringr::str_to_sentence(details$title)` responsibilities
...
As the *`r details$title`*, we expect you to:
...
research software engineers (one 5 year and one 2 year positions), a data
manager, a database administrator, a team leader, as well as affiliate researchers
and the primary investigator. We think we're a fun and relaxed group, and we
have a great working environment and colleagues :) 
