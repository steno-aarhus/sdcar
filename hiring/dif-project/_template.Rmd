...
and developed. Aside from working on the DIF, other responsibilities for
...
improved upon
- Building, internal testing, and developing each component of the DIF into
...
Responsibilities **specific to the `r params$position_title`** also include:
...
- Communicating with Statistics Denmark to refine how the DIF project may be
implemented
```
...
Qualifications and experience **specific to the `r params$position_title`** also include:

```{asis, echo=params$position == "rse"}
- Experienced or familiar with either using Python or R for general programming
tasks (should be open to learning both)
...
- Knowledge of or experience in using R and/or Python for scientific data
analysis and/or research software development
```
...
```{asis, echo=params$position == "dm"}
- Familiar with the DD2 project, database, and procedures (TODO: Include?)
