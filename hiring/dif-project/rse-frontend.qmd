...
*Note*, we anticipate that work on the Seedcase project will not take up
all full-time work, so depending on the applicant's interest, we
encourage and support the research software engineer to collaborate on
research projects outside of the project time.
